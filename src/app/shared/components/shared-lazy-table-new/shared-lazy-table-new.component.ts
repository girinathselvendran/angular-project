...
@Component({
  selector: 'app-shared-lazy-table-new',
  templateUrl: './shared-lazy-table-new.component.html',
  styleUrls: ['./shared-lazy-table-new.component.css']
})
export class SharedLazyTableNewComponent implements OnInit {
  sendForReject(_t24: Table) {
  ...
  @Input() rejectIcon: boolean = false;
  @Input() sendIcon: boolean = false;
  ...
  @Output() printIconFn = new EventEmitter();
  @Output() reopenIconFn = new EventEmitter();
  @Output() emailIconFn = new EventEmitter();
  @Output() sendForApprovalIconFn = new EventEmitter();
  @Output() rejectIconFn = new EventEmitter();
  @Output() cancelIconFn = new EventEmitter();
  @Output() approvalIconFn = new EventEmitter();
  @Output() sendIconFn = new EventEmitter();


  @Input() disableAddNewIcons: boolean = false;
  @Input() disableSendForApprovalIcons: boolean = false;
  @Input() disableRejectIcons: boolean = false;
  ...
  @Input() disableALLGridIcons: boolean = false;
  @Input() disableSendIcons: boolean = false;

  @Input() titleSendIcon: string = this.translate.instant("common.grid.tooltip.send");
  ...
  changeTableTitle(tableTitle: any) {
  ...
  handlePrintIcon() {
    ...
    this.printIconFn.emit(true);
  }

  handleReopenIcon() {


    this.reopenIconFn.emit(true);
  }
  handleEmailIcon() {


    this.emailIconFn.emit(true);
  }
  handleApprovalIcon() {
    this.approvalIconFn.emit(true);

  }
  handleSendForApprovalIcon() {


    this.sendForApprovalIconFn.emit(true);
  }
  handleSendIcon() {


    this.sendIconFn.emit(true);
  }
  handleRejectIcon() {
    this.rejectIconFn.emit(true);
  }

  handleCancelIcon() {
    this.cancelIconFn.emit(true);
