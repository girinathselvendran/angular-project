...
import { SharedTableV2StoreService } from "../../services/store/shared-table-v2-store.service";

@Component({
  selector: 'app-shared-lazy-table-v2',
  templateUrl: './shared-lazy-table-v2.component.html',
  styleUrls: ['./shared-lazy-table-v2.component.css']
})
export class SharedLazyTableV2Component implements OnInit {
  ...
  constructor(
    ...
    private sharedTableStoreService: SharedTableV2StoreService,
